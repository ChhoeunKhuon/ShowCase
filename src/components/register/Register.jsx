...
export function ComponentRegister() {
  ...
  return (
    <div className="flex flex-row items-center justify-center dark:bg-gray-900">
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
      className={`3xl:w-[2026px] 3xl:mx-auto sm:px-3 sm-max:px-3 flex sm:flex-col-reverse sm-max:flex-col-reverse lg:flex-row w-full h-full lg:w-[100vw] lg:h-[100vh] p-10 lg:p-10 justify-center items-center xl:gap-10 overflow-auto ${
