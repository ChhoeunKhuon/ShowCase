...
function LoginSection() {
  ...
  return (
    ...
    <motion.main
      ...
      className={`3xl:w-[2026px] 3xl:mx-auto sm:px-3 sm-max:px-3 flex sm:flex-col-reverse sm-max:flex-col-reverse py-20 lg:flex-row w-full h-full lg:w-[100vw] lg:h-[100vh] lg:p-10 justify-start xl:gap-10 items-center overflow-auto  ${
